...
public class ArrayIndexedCollection implements List {
	...
	/**
	 * The {@code ArrayElementsGetter} class represents an object whose purpose is to fetch elements
	 * of the {@code ArrayIndexedCollection} instance, one by one, on demand.
	 * 
	 * @author Iva Maria Ivanković
	 * @version 1.0
	 */
	private static class ArrayElementsGetter implements ElementsGetter {
		...
		/**
		 * Index of the first non-fetched element.
		 */
		private int nextNonFetchedElement;
		
		/**
		 * The number of modifications made on the backing collection at the moment of instancing the {@code ArrayElementsGetter}.
		 */
		private long savedModificationCount;
		
		/**
		 * Creates an instance of the {@code ArrayElementsGetter} class for the provided collection and sets
		 * the {@code nextNonFetchedElement} to its default value.
		 * 
		 * @param collection the collection whose elements are to be fetched using the {@code ArrayElementsGetter} class.
		...
		public boolean hasNextElement() {
			if(this.savedModificationCount != this.arrayCollection.modificationCount) throw new ConcurrentModificationException("The collection has been modified.");
			return this.nextNonFetchedElement < this.arrayCollection.size;
		}
		...
		public Object getNextElement() {
			...
			return this.arrayCollection.get(nextNonFetchedElement++);
		}
	}
	
	/**
	 * Creates a new instance of {@code ElementsGetter} class in order to fetch elements of the backing array of the {@code ArrayIndexedCollection}.
	 * 
	 * @return instance of {@code ElementsGetter} class for use in the context of the current {@code ArrayIndexedCollection}.
	 */
	@Override
	...
	public boolean equals(Object obj) {
		...
		return this.size == other.size && Arrays.equals(this.elements, other.elements);
	}
	...
	public int hashCode() {
		int result = 1;
		int hash = this.size + Arrays.hashCode(this.elements);
