...
public class LinkedListIndexedCollectionTest {
	...
	private LinkedListIndexedCollection nullCollection;
	private LinkedListIndexedCollection emptyCollection;
	private LinkedListIndexedCollection oneElementCollection;
	private LinkedListIndexedCollection twoToTenElementsCollection;
	private LinkedListIndexedCollection constantCollection;
	...
	void setUp() {
		...
		oneElementCollection = new LinkedListIndexedCollection();
		...
		twoToTenElementsCollection = new LinkedListIndexedCollection();
		...
		constantCollection = new LinkedListIndexedCollection();
